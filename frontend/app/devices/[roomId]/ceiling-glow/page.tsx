...
export default function SmartLightPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#0E0E0E] text-white font-sans overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0 md:ml-20" style={{ backgroundImage: "url('/bg-stars.svg')" }}> {/* Placeholder for bg effect if needed */}
        <LightTopNav />

        <main className="flex-1 mt-14 overflow-y-auto px-8 py-8 md:py-12 flex flex-col lg:flex-row gap-12 lg:gap-24 scrollbar-hide items-start justify-center">
          
          {/* ── Left Column: Main Light Control ── */}
          <div className="flex flex-col items-center flex-1 max-w-3xl mx-auto w-full">
            {/* Header */}
            ...
            <div className="relative w-[340px] h-[340px] flex items-center justify-center mb-12 cursor-pointer transition-transform hover:scale-105 active:scale-95" onClick={() => setIsOn(!isOn)}>
              ...
              {/* Outer faint rings mapped to size of bulb graphic */}
              <div
          ...
          <aside className="w-full lg:w-[280px] lg:pt-14 flex flex-col gap-10 lg:pl-6 xl:pl-10">
            {/* Living Room Area */}
            <div>
            ...
            {/* Efficiency Tip */}
            <div className="rounded-2xl p-5 border border-[rgba(253,211,77,0.1)] mt-auto mb-10 lg:mb-0" style={{ background: "linear-gradient(180deg, rgba(253,211,77,0.05) 0%, rgba(26,26,26,0.8) 100%)" }}>
