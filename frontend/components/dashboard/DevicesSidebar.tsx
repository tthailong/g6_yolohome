...
export default function DevicesSidebar() {
  ...
  return (
    <aside
      className="fixed left-0 top-0 h-full w-20 flex flex-col justify-between items-center py-8 z-40"
      style={{
    ...
    >
      <div className="flex flex-col items-center gap-8 w-full">
        ...
        <div className="flex justify-center w-full mb-2">
          ...
          >
            <span className="font-manrope font-bold text-xl" style={{ color: "#5C4900" }}>L</span>
          </div>
        </div>

        <nav className="flex flex-col items-center gap-2 w-full">
          {/* Dashboard */}
          <Link href="/" className="flex justify-center items-center w-full py-3 rounded-xl cursor-pointer hover:bg-[#1A1A1A] transition-colors relative">
