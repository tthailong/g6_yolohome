    ...
    >
      <div className="flex flex-col items-center gap-8 w-full">
        ...
        <nav className="flex flex-col items-center gap-2 w-full">
          ...
          {/* Members */}
          <Link href="/members" className="relative flex justify-center w-full py-3 rounded-xl cursor-pointer hover:bg-[#1A1A1A] transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path 
                d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z" 
                fill={pathname.startsWith("/members") ? "#FDD34D" : "#ADAAAA"}
              />
            </svg>
            {pathname.startsWith("/members") && <div className="absolute right-0 top-0 bottom-0 w-[2px] bg-[#FDD34D]" />}
          </Link>

          {/* Settings */}
          <Link href="/settings" className="relative flex justify-center w-full py-3 rounded-xl cursor-pointer hover:bg-[#1A1A1A] transition-colors">
            <svg width="21" height="20" viewBox="0 0 21 20" fill="none">
              <path 
                ...
                fill={pathname.startsWith("/settings") ? "#FDD34D" : "#ADAAAA"}
              />
            </svg>
            {pathname.startsWith("/settings") && <div className="absolute right-0 top-0 bottom-0 w-[2px] bg-[#FDD34D]" />}
          </Link>
        </nav>
      </div>
      ...
      <button
        ...
        className="relative flex justify-center w-full py-3 rounded-xl cursor-pointer hover:bg-[#1A1A1A] transition-colors focus:outline-none"
      >
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
